...
AvailableAbilities GetAbilitiesForUnit (
    ...
    vector<AvailableAbilities> available_abilities = Query_Face::GetAbilitiesForUnits (
        { unit },
...
float PathingDistance ( const Point2D& start, const Point2D& end ) {
