...
//! Unit weapon.
struct Weapon {
    enum class TargetType { Invalid = 0, Ground = 1, Air = 2, Any = 3,  };

    TargetType               type;
    float                    damage_;
    vector<DamageBonus> damage_bonus; // Extra damage when attacking a unit of a certain attribute
...
typedef vector<UnitTypeData> UnitTypes;
