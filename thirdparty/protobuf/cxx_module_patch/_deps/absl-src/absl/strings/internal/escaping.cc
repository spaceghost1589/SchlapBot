...
size_t Base64EscapeInternal(const unsigned char* src, size_t szsrc, char* dest,
  ...
  switch (szsrc) {
    ...
    default:
      ...
      #if defined(_MSC_VER) || defined(__MINGW32__)         // Windows / MinGW safe format specifier
        ABSL_RAW_LOG(FATAL, "Logic problem? szsrc = %llu", static_cast<unsigned long long>(szsrc));
      #else                                                 // Standard GCC/Clang Linux format specifier
